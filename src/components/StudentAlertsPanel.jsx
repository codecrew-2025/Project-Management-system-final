...
export default function StudentAlertsPanel({ alerts = [], loading = false, errorMessage = '' }) {
  ...
  return (
    <div style={{ padding: '20px' }}>
      <div style={{ marginBottom: '20px' }}>
        <h2 style={{ margin: '0 0 4px 0', fontSize: '1.5rem', fontWeight: 700 }}>🚨 Your Alerts</h2>
      ...
      {!loading && filteredAlerts.length === 0 && (
        <div style={{ textAlign: 'center', padding: '30px 20px', color: '#6b7280' }}>
          ...
          <div style={{ fontSize: '0.95rem', fontWeight: 600 }}>No alerts for you</div>
          <div style={{ fontSize: '0.85rem', marginTop: '4px' }}>Great! Stay on track with your work.</div>
        </div>
      )}
